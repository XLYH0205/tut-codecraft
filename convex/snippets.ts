...
export const deleteSnippet = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (snippet.userId !== identity.subject) throw new Error("User does not own this snippet");
...
export const deleteComment = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (comment.userId !== identity.subject) throw new Error("User does not own this comment");
